 ...
 * ----------------------------------------------------------------------------
 */
class PluginPicalbums_BlockPicalbumsBestPictures extends Block {
	public function Exec() {
        $oUserCurrent = $this->User_GetUserCurrent();
		$aPictures = $this->PluginPicalbums_Picture_GetLastBestPictures($oUserCurrent ? true : false , Config::Get ( 'plugin.picalbums.block_best_count' ));
        ...
        $oViewer->Assign('sTitle',  $this->Lang_Get ( 'picalbums_block_best_pictures' ));
