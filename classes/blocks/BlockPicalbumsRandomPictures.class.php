...
class PluginPicalbums_BlockPicalbumsRandomPictures extends Block {
	public function Exec() {
        $oUserCurrent = $this->User_GetUserCurrent();
		$aPictures = $this->PluginPicalbums_Picture_GetRandomPictures($oUserCurrent ? true : false, Config::Get ( 'plugin.picalbums.block_random_count' ));
        ...
        $oViewer->Assign('sTitle',  $this->Lang_Get ( 'picalbums_block_random_pictures' ));
