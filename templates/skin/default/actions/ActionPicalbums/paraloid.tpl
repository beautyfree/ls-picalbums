...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{$sTemplateWebPathPicalbumsPlugin}/css/paraloid/style.css" type="text/css" media="screen"/>		
		<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
		<script src="{$sTemplateWebPathPicalbumsPlugin}/js/paraloid/cufon-yui.js" type="text/javascript"></script>
		<script src="{$sTemplateWebPathPicalbumsPlugin}/js/paraloid/Note_this_400.font.js" type="text/javascript"></script>
    ...
    <body>
		<h1>{$oUserProfile->GetLogin()} Albums</h1>
				        ...
				        {if $aPictures}
                            <div class="album">
                                {foreach from=$aPictures item=oPicture}
                                    <div class="content">
                                        <img src="{$oPicture->getMiniaturePath()}" alt="{$oPicture->getPicPath()}" />
                                        <span>{$oPicture->getDescription()}</span>
                                    </div>
                                {/foreach}
        ...
        <!-- The JavaScript -->
		<script src="{$sTemplateWebPathPicalbumsPlugin}/js/paraloid/jquery.transform-0.8.0.min.js"></script>
		{literal}		
        <script type="text/javascript">
            $(function() {
				var ie 			= false;
