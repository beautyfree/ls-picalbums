...
<html>
    <head>
        <title>{$oUserProfile->GetLogin()} Albums</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
        	<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
		<script src="{$sTemplateWebPathPicalbumsPlugin}/js/slidergallery/cufon-yui.js" type="text/javascript"></script>
		<script src="{$sTemplateWebPathPicalbumsPlugin}/js/slidergallery/GreyscaleBasic.font.js" type="text/javascript"></script>
		<script type="text/javascript">
			Cufon.replace('h1,h2,.fp_close,.reference');
		</script>
		
		<link type="text/css" href="{$sTemplateWebPathPicalbumsPlugin}/css/slidergallery/jquery.ui.theme.css" rel="stylesheet" />
		<link type="text/css" href="{$sTemplateWebPathPicalbumsPlugin}/css/slidergallery/jquery.ui.core.css" rel="stylesheet" />
        	<link type="text/css" href="{$sTemplateWebPathPicalbumsPlugin}/css/slidergallery/jquery.ui.slider.css" rel="stylesheet" />
		<link rel="stylesheet" href="{$sTemplateWebPathPicalbumsPlugin}/css/slidergallery/style.css" type="text/css" media="screen"/>
    ...
    <body>
		<div id="fp_gallery" class="fp_gallery">
			<img src="{$sTemplateWebPathPicalbumsPlugin}/images/slidergallery/bgimg.jpg" class="fp_bgImage" />
			<div class="fp_bgPattern"></div>
			<h1>{$oUserProfile->GetLogin()}</h1>
			<h2>Albums</h2>
					...
					<div class="container">
						{if $aPictures}
							{foreach from=$aPictures item=oPicture}
								<div class="content">
									<div><a href="#"><img src="{$oPicture->getMiniaturePath()}" alt="{$oPicture->getPicPath()}" class="thumb" /></a></div>
								</div>
							{/foreach}
						{/if}
					</div>
        ...
        <div>
            <span class="reference">
                <a href="{$oUserProfile->getUserAlbumsWebPath()}">back to the Album Normal Mode</a>
            </span>
		</div>
		<!--  JAVASCRIPT -->
		<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/jquery-ui.min.js"></script>
		<script type="text/javascript" src="{$sTemplateWebPathPicalbumsPlugin}/js/slidergallery/jquery.easing.1.3.js"></script>
		{literal}
		<script type="text/javascript">
			$(function() {
				//caching
				...
				function openGallery($gallery){
					...
					*/
					...
					$fp_thumbContainer.animate({'height':'135px'},200,function(){
